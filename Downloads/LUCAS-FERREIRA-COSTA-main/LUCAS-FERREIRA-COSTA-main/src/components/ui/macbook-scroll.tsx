...
export const MacbookScroll = ({
  ...
  // New "Disintegration" transforms for the screen
  const screenOpacity = useTransform(scrollYProgress, [0.4, 0.65], [1, 0]);
  const screenScale = useTransform(scrollYProgress, [0.4, 0.7], [1, 1.4]);
  const screenFilter = useTransform(
    scrollYProgress, 
    [0.4, 0.65], 
    ["blur(0px) brightness(1) saturate(1) contrast(1)", "blur(40px) brightness(5) saturate(0) contrast(2)"]
  );
  const screenClipPath = useTransform(
    scrollYProgress, 
    [0.4, 0.6], 
    ["circle(120% at 50% 50%)", "circle(0% at 50% 50%)"]
  );
...
export const Lid = ({
  ...
  screenScale?: MotionValue<number>;
  screenFilter?: MotionValue<string>;
  screenClipPath?: MotionValue<string>;
}) => {
  return (
    ...
    <div className="mx-1 h-full [transform:translateZ(0)] rounded-md bg-[#050505] p-1 [will-change:transform]">
      ...
      <div className="mb-[2px] flex w-full shrink-0 gap-[2px]">
        ...
        <KBtn>
          ...
          <span className="mt-1 inline-block text-[3px]">F1</span>
        </KBtn>
        <KBtn>
          <IconBrightnessUp className="h-[6px] w-[6px]" />
          <span className="mt-1 inline-block text-[3px]">F2</span>
        </KBtn>
        <KBtn>
          <IconTable className="h-[6px] w-[6px]" />
          <span className="mt-1 inline-block text-[3px]">F3</span>
        </KBtn>
        <KBtn>
          <IconSearch className="h-[6px] w-[6px]" />
          <span className="mt-1 inline-block text-[3px]">F4</span>
        </KBtn>
        <KBtn>
          <IconMicrophone className="h-[6px] w-[6px]" />
          <span className="mt-1 inline-block text-[3px]">F5</span>
        </KBtn>
        <KBtn>
          <IconMoon className="h-[6px] w-[6px]" />
          <span className="mt-1 inline-block text-[3px]">F6</span>
        </KBtn>
        <KBtn>
          <IconPlayerTrackPrev className="h-[6px] w-[6px]" />
          <span className="mt-1 inline-block text-[3px]">F7</span>
        </KBtn>
        <KBtn>
          <IconPlayerSkipForward className="h-[6px] w-[6px]" />
          <span className="mt-1 inline-block text-[3px]">F8</span>
        </KBtn>
        <KBtn>
          <IconPlayerTrackNext className="h-[6px] w-[6px]" />
          <span className="mt-1 inline-block text-[3px]">F9</span>
        </KBtn>
        <KBtn>
          <IconVolume3 className="h-[6px] w-[6px]" />
          <span className="mt-1 inline-block text-[3px]">F10</span>
        </KBtn>
        <KBtn>
          <IconVolume2 className="h-[6px] w-[6px]" />
          <span className="mt-1 inline-block text-[3px]">F11</span>
        </KBtn>
        <KBtn>
          <IconVolume className="h-[6px] w-[6px]" />
          <span className="mt-1 inline-block text-[3px]">F12</span>
        </KBtn>
        <KBtn>
